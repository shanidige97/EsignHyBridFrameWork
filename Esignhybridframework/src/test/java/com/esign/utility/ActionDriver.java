...
public class ActionDriver extends DriverBase implements ActionInterface {
	...
	public boolean draggableAndRelaese(WebDriver driver, WebElement source, int x, int y) {
		boolean flag = false;
		try {
			...
			action.dragAndDropBy(source, x, y).release().click().build().perform();
			Thread.sleep(5000);
			flag = true;
			return true;
